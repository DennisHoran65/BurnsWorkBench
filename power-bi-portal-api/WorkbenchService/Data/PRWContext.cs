...
{
    public partial class PRWContext : DbContext
    {
        public PRWContext()
        {
        }

        public PRWContext(DbContextOptions<PRWContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=burns-azure-sql02.database.windows.net,1433;Database=PRW_DEV;User ID=burnssqladmindev;Password=Burn$@dm!ndev;Trusted_Connection=False;Encrypt=True;");
            }
        }
